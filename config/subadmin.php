...
<head>
    ...
    <title>Log into Sub Admin</title>
    <!--<script defer data-api="../resource/stats/api/event" src="../resource/stats/js/script.js"></script>-->
  ...
  <body  class=" d-flex flex-column bg-white">
    ...
    <div class="row g-0 flex-fill">
        ...
        <!-- Photo -->
        <div class="bg-cover h-100 min-vh-100" style="background-image: url(../resource/static/photos/workplace-with-laptop-on-table-at-home-4.jpg)"></div>
      </div>
      <div class="col-12 col-lg-6 col-xl-4 border-top-wide border-primary d-flex flex-column justify-content-center">
        <div class="container container-tight my-5 px-lg-5">
          ...
          <h2 class="h3 text-center mb-3">
            Login to Sub Admin Account
          </h2>
          <form action="subadmin_authentication.php" method="post" autocomplete="off" novalidate>
            <div class="mb-3">
