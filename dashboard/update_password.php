...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($stmt->execute()) {
        ...
        echo "<script>alert('Error updating password. Please try again.'); window.location.href = 'change-user-password.php';</script>";
    }
}
...
<div class="portlet-grid-page">  
    ...
    <button type="submit" class="btn btn-primary" style="text-decoration:none !important;"> Update Password</button>
		...
		<div class="clearfix"> </div>
		    ...
		    <a href="user_profile.php" class="hvr-icon-float-away hvr-trim" style="text-decoration:none !important;"> View User Profile</a>
		</div>
  </div>
