...
include("config/connection.php");
    $sql = "SELECT * FROM other_pages WHERE page_name ='Terms & Conditions' ";
...
?>
  ...
  <!DOCTYPE html>
        ...
        <head>
            ...
            <meta name="description" content="<?php echo  $serviced['meta_description']; ?>">
            <meta name="keywords" content="<?php echo  $serviced['meta_Keywords']; ?>">
            <title><?php echo  $serviced['meta_title']; ?></title>
                <!--Favicon-->
