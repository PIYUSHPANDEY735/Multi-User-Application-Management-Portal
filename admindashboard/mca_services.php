               ...
               <div class="work-progres">
                            <div class="chit-chat-heading" style="font-size:30px;text-align:center;color:#000;margin-bottom:10px;display:flex;align-items:center;justify-content:space-around;">
                                  ...
                                  <div class="btn-effcts panel-widget" style="margin:0px;padding:0px;padding-left: 5px;padding-right: 5px;background: #d9d9d9;width:auto;">
                                      <a href="add-mca-service.php" class="hvr-icon-float-away hvr-trim" style="text-decoration:none !important;">Create New Service</a>
                                  </div>
                                  <div class="btn-effcts panel-widget" style="margin:0px;padding:0px;padding-left: 5px;padding-right: 5px;background: #d9d9d9;width:auto;">
                                      <a href="mca-callback-enquiries.php" class="hvr-icon-float-away hvr-trim" style="text-decoration:none !important;">Service Enquiries</a>
                                  </div>
              ...
              <?php
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<td><a class='btn btn-primary' href='update-mca-service.php?id=" . $row['id'] . "'>Update Service</a></td>";
...
<script type="text/javascript">
  function confirmDelete(serviceId) {
    ...
    if (confirm("Are you sure you want to delete this service?")) {
      ...
      window.location.href = "delete-mca-service.php?id=" + serviceId;
    } else {
      // Redirect to the MCA services page if "No"
      window.location.href = "mca_services.php";
    }
  }
</script>
