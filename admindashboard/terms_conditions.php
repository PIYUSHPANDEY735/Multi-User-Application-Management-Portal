...
$query = "SELECT * FROM terms_conditions WHERE id='1'";
              ...
              <?php
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<td>
        <a href='update-terms-conditions.php?id=" . $row['id'] . "' class='btn btn-primary'>Update Service</a>
      </td>";
                        echo "<td><a class='btn btn-success' href='../terms-and-conditions.php'>View Service</a></td>";
