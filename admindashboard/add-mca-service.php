                    ...
                    <div class="col-md-12">
                        ...
                        <div id="testimonials-container">
                            <div class="testimonial-item">
                                <input type="text" class="form-control" name="testimonial_name[]" placeholder="Name">
                                <input type="text" class="form-control" name="testimonial_profession[]" placeholder="Profession">
                                <textarea class="form-control" name="testimonial_text[]" placeholder="Testimonial"></textarea>
                                <input type="number" class="form-control" name="testimonial_rating[]" placeholder="Rating (1-5) like(3.2)" min="1" max="5">
                            </div>
                        </div>
...
function addTestimonial() {
    ...
    newTestimonial.innerHTML = `
        ...
        <input type="text" class="form-control" name="testimonial_profession[]" placeholder="Profession">
        <textarea class="form-control" name="testimonial_text[]" placeholder="Testimonial"></textarea>
        <input type="number" class="form-control" name="testimonial_rating[]" placeholder="Rating (1-5)" min="1" max="5">
    `;
