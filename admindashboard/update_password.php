...
<div class="portlet-grid-page">  
    ...
    <button type="submit" class="btn btn-primary" style="text-decoration:none !important;"> Update Password</button>
		...
		<div class="clearfix"> </div>
		    ...
		    <a href="admin_profile.php" class="hvr-icon-float-away hvr-trim" style="text-decoration:none !important;"> View Admin Profile</a>
		</div>
  </div>
...
<!--inner block end here-->
 ...
 <?php
    ...
    echo "No Admin details found for this ID.";
}
