               ...
               <div class="work-progres">
                            <div class="chit-chat-heading" style="font-size:30px;text-align:center;color:#000;margin-bottom:10px;display:flex;align-items:center;justify-content:space-around;">
                                  ...
                                  <div class="btn-effcts panel-widget" style="margin:0px;padding:0px;padding-left: 5px;padding-right: 5px;background: #d9d9d9;width:auto;">
                                      <a href="add-new-blog.php" class="hvr-icon-float-away hvr-trim" style="text-decoration:none !important;">Create New Blog</a>
                                  </div>
                                  <!--<div class="btn-effcts panel-widget" style="margin:0px;padding:0px;padding-left: 5px;padding-right: 5px;background: #d9d9d9;width:auto;">-->
              ...
              <?php
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<td><a class='btn btn-info' href='../blogs.php?slug=" . $row['blog_slug'] .  "&id=" . $row['id'] . "' >View Blog</a></td>";
                        echo "<td><a class='btn btn-primary' href='update-blog.php?id=" . $row['id'] . "'>Update Blog</a></td>";
                        echo "<td><a class='btn btn-warning' href='#' onclick='confirmDelete(" . $row['id'] . ")'>Delete Blog</a></td>";
...
<script type="text/javascript">
  function confirmDelete(serviceId) {
    ...
    if (confirm("Are you sure you want to delete this Blog?")) {
      ...
      window.location.href = "delete-blog.php?id=" + serviceId;
    } else {
