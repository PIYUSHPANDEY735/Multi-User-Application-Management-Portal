...
try {
    ...
    $sql = "SELECT id, userid, ownerName, businessName, aadharNumber, panNumber, businessAddress, bankDetails, businessActivity,  created_at, current_status  FROM msme_registration";
