...
try {
    ...
    $sql = "SELECT id, userid, company_name, registration_number, financial_year, total_assets, total_liabilities, net_worth, remarks, created_at, current_status  FROM balance_sheet";
