...
$query = "SELECT * FROM contact_enquiries";
              ...
              <?php
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<td><a class='btn btn-primary' href='view-contact-details.php?id=" . $row['id'] . "'>View Record</a></td>";
...
<script>
    async function downloadExcel() {
        try {
            ...
            const response = await fetch('export-contact-enquiries.php'); // Adjust path if needed
