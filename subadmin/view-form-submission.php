...
$sql = "SELECT field_label, field_value FROM form_submissions WHERE service_id = ?";
...
<?php endif; ?>
        ...
        <div class="portlet-grid panel-info">
            <div class="panel-body">
                <a href="manage-submissions.php" class="btn btn-secondary">Back to Form Submissions</a>
            </div>
        </div>
    </div>
</div>
