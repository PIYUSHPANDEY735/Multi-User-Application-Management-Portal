...
$sql = "SELECT * FROM user WHERE id = $registration_id";
...
<div class="portlet-grid-page">  
    	<h2>Overall Registered User Details</h2>	
	...
	<div class="portlet-grid panel-info"> 
		...
		<div class="portlet-grid panel-info">
			 <div class="panel-heading">
    		  ...
    		  <div class="panel-body">
    		    Here you can see the assigned services to the admin
    		  </div>
		</div>
		<?php } else { ?>
		...
		<div class="portlet-grid panel-info">
			 <div class="panel-heading">
    		      <h3 class="panel-title">Assgined Services</h3>
    		  </div> 
    		  <div class="panel-body">
    		    You cannot assign services to the normal user
    		  </div>
		</div>
